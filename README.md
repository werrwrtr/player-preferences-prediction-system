...
| **1. Сбор** | `сбор_данных/` | Парсинг данных о пользователях, играх и деталях |
| **2. Предобработка** | `обработка_данных/` | Очистка, нормализация, слияние таблиц в Parquet |
| **3. Анализ** | ` анализ_данных/` | TF-IDF признаки, статистический анализ |
| **4. Обучение** | `model/` | Обучение 4 моделей: Content-Based, PMF, NeuMF, LightGCN |
