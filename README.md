...
| Модель | Тип | Метрики | Время |
|--------|-----|---------|-------|
| **Content-Based** | TF-IDF + Cosine | P@10, R@10, NDCG@10 | ~5 мин |
| **PMF** | Matrix Factorization | MAE, RMSE, AUC | ~7 мин |
| **NeuMF** | Two-Tower NN | MAE, RMSE, AUC | ~15 мин |
| **BPR** | Bayesian Ranking | AUC, MAP, NDCG | ~10 мин |
| **LightGCN** | Graph NN | P@10, R@10, NDCG | ~20 мин |
...
| Модель | Precision@10 | Recall@10 | NDCG@10 | AUC | RMSE |
|--------|--------------|-----------|---------|-----|------|
| Content-Based | 0.0091 | 0.0104 | 0.0445 | - | - |
| PMF | 0.0054 | 0.0054 | 0.0064 | 0.8302 | 0.8111 |
| NeuMF | - | - | - | - | - |
| BPR | - | - | - | - | - |
| LightGCN | - | - | - | - | - |
